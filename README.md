...
I build end-to-end ML pipelines, web applications, and data-driven tools. Currently Data & AI Engineering intern at Nepita (MedTech) — self-hosted LLMs, RAG, CI/CD. Focused on NLP, Knowledge Graphs, and applied Machine Learning.

## Tech Stack

**Languages:** Python, JavaScript, TypeScript, SQL, C/C++
**ML / Data:** scikit-learn, TensorFlow, Keras, PyTorch, Pandas, NumPy, spaCy, rdflib
**LLM / NLP:** Ollama, self-hosted LLM deployment, RAG pipelines, Whisper
**Backend:** FastAPI, Node.js
**Frontend:** React, Next.js, Tailwind CSS, Framer Motion
**Tools:** Git, Docker, CI/CD, Jupyter, Power BI, Linux/WSL2
...
[![GitHub](https://img.shields.io/badge/GitHub-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/noahlips)
